...
set_property PACKAGE_PIN C16 [get_ports eth_rstn]
...
set_clock_groups -asynchronous -group [get_clocks rx_clk] -group [get_clocks tx_clk] -group [get_clocks clk_100]
...
set_input_delay  -clock rx_clk -max 10.0 [get_ports rst]
